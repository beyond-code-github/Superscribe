namespace Superscribe.Testing.WebApi
{
    ...
    public static class BenchmarkConfig
    {
        public static void Register(HttpConfiguration config)
        {
            ...
            var site = ʃ.Route(o => o / "sites" / (Int)"siteId");
            ...
            ʃ.Route(o => blogposts / -(Int)"postId" / -"media".Controller("blogpostmedia") / -(Int)"id");
            ...
            ʃ.Route(o => blogposts / "archives".Controller("blogpostarchives") / -(Int)"year" / (Int)"month");
        ...
        private static void GenerateRoutes(GraphNode site, string name)
        {
            ...
            ʃ.Route(o => projectsroute / -"media".Controller(name + "projectmedia") / -(Int)"id");
            ...
            ʃ.Route(o => baseroute / "categories".Controller(name + "categories") / -(Int)"id");
        }
    }
}